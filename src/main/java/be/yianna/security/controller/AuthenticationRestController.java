...
public class AuthenticationRestController {
    ...
    public ResponseEntity<?> createAuthenticationTokenForSignUp(@RequestBody JwtAuthenticationRequest authenticationRequest) throws AuthenticationException {
    ...
    public ResponseEntity<?> createAuthenticationTokenForLogin(@RequestBody JwtAuthenticationRequest authenticationRequest) throws AuthenticationException {
